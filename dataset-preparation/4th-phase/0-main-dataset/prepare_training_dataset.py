...
extrapolation_df_original = pdc.add_dataset_node_index(extrapolation_df_original, node_index=DATASET_LOCATION_INDEX)
...
extrapolation_df_with_node_index = pdc.add_job_node_index(extrapolation_df_original, nodes_df=nodes_df)
