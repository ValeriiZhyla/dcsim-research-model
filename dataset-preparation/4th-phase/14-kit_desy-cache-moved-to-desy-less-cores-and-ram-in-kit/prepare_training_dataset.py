...
PLATFORM_FILE_NAME = 'WLCG_disklessTier2_reduced100-storage-cache-switched-less-cores-and-ram-in-kit.xml'
WORKLOAD_FILE_NAME_PREFIX = 'T2_DE_DESY_workloads_'
DATASET_FILE_NAME_PREFIX = 'realData_DESY_cache-large_'
