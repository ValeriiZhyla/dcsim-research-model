...
def train_and_evaluate_model():
    ...
    # Load data
    train_df = pd.read_csv('../../dataset-preparation/third-phase/train_dataset.csv')
    test_df = pd.read_csv('../../dataset-preparation/third-phase/test_dataset.csv')
    #train_df = pd.read_csv('../../dataset-preparation/third-phase/train_dataset_small.csv')
    #test_df = pd.read_csv('../../dataset-preparation/third-phase/test_dataset_small.csv')
