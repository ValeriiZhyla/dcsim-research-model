...
train_df = pd.read_csv('../../simulation-dataset-preparation/second-phase/extrapolation_dataset.csv')
...
def apply_model_to_data():
    ...
    model = torch.load('../../trained-models/second-phase/lstm.pth')
    ...
    commons.denorm_and_plot(output_columns, output_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="extrapolation")
