...
hyperparameter_combinations = [
    Hyperparameters("50-default", "../../../dataset_preparation/evaluation/extrapolation/50", epochs=100, window_size=100, window_overlap=0, batch_size=128, hidden_size=20, layers=1),
    Hyperparameters("50-plus", "../../../dataset_preparation/evaluation/extrapolation/50+1", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=20, layers=1),
