...
hyperparameter_combinations = [
    ...
    Hyperparameters("50-default", "../../../dataset_preparation/evaluation/extrapolation/50", epochs=400, window_size=100, window_overlap=0, batch_size=256, hidden_size=16, heads=4, encoders=1),
    Hyperparameters("50-plus", "../../../dataset_preparation/evaluation/extrapolation/50+1", epochs=400, window_size=100, window_overlap=0, batch_size=256, hidden_size=16,
                    heads=4, encoders=1),
