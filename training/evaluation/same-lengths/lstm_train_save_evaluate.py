...
hyperparameter_combinations = [
    Hyperparameters("1", "../../../dataset_preparation/evaluation/same_length/1", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
    Hyperparameters("10", "../../../dataset_preparation/evaluation/same_length/10", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
    Hyperparameters("20", "../../../dataset_preparation/evaluation/same_length/20", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
    Hyperparameters("30", "../../../dataset_preparation/evaluation/same_length/30", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
    Hyperparameters("40", "../../../dataset_preparation/evaluation/same_length/40", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
    Hyperparameters("50", "../../../dataset_preparation/evaluation/same_length/50", epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
