...
hyperparameter_combinations = [
    ...
    Hyperparameters("30", "../../dataset_preparation/evaluation/30", epochs=1000, window_size=150, window_overlap=0, batch_size=64, hidden_size=128, layers=1),
    Hyperparameters("40", "../../dataset_preparation/evaluation/40", epochs=1000, window_size=150, window_overlap=0, batch_size=64, hidden_size=128, layers=1),
    ...
    Hyperparameters("75", "../../dataset_preparation/evaluation/75", epochs=500, window_size=150, window_overlap=0, batch_size=64, hidden_size=128, layers=1),
    ...
    Hyperparameters("500", "../../dataset_preparation/evaluation/500", epochs=300, window_size=150, window_overlap=0, batch_size=64, hidden_size=128, layers=1),

    Hyperparameters("50", "../../dataset_preparation/evaluation/50", epochs=500, window_size=150, window_overlap=0, batch_size=64, hidden_size=128, layers=1),
