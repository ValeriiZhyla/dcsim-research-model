...
# Load dataframes
test_df = pd.read_csv('../../../dataset-preparation/4th-phase/extrapolation/15-kit_desy-cache-moved-to-desy-more-cores-in-desy-extrapolation/extrapolation_dataset.csv', sep=";")
nodes_aux_df = pd.read_csv('../../../dataset-preparation/4th-phase/extrapolation/15-kit_desy-cache-moved-to-desy-more-cores-in-desy-extrapolation/nodes_aux.csv', sep=";")
links_aux_df = pd.read_csv('../../../dataset-preparation/4th-phase/extrapolation/15-kit_desy-cache-moved-to-desy-more-cores-in-desy-extrapolation/links_aux.csv', sep=";")
