...
# Load dataframes
test_df = pd.read_csv('../../../dataset_preparation/4th-phase/extrapolation/15-kit_desy-cache-moved-to-desy-more-cores-in-desy-extrapolation/extrapolation_dataset.csv', sep=";")
nodes_aux_df = pd.read_csv('../../../dataset_preparation/4th-phase/extrapolation/15-kit_desy-cache-moved-to-desy-more-cores-in-desy-extrapolation/nodes_aux.csv', sep=";")
links_aux_df = pd.read_csv('../../../dataset_preparation/4th-phase/extrapolation/15-kit_desy-cache-moved-to-desy-more-cores-in-desy-extrapolation/links_aux.csv', sep=";")
...
def apply_model_to_data():
    ...
    plotting.denorm_and_plot_predicted_actual(output_columns_jobs, output_jobs_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="15-easy_extrapolation_x10")

    # Create KDE plot
    plotting.plot_kde(output_columns_jobs, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="15-easy_extrapolation_x10")
