...
# Load dataframes
test_df = pd.read_csv('../../../dataset-preparation/4th-phase/extrapolation/17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation/extrapolation_dataset.csv', sep=";")
nodes_aux_df = pd.read_csv('../../../dataset-preparation/4th-phase/extrapolation/17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation/nodes_aux.csv', sep=";")
links_aux_df = pd.read_csv('../../../dataset-preparation/4th-phase/extrapolation/17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation/links_aux.csv', sep=";")
...
def apply_model_to_data():
    ...
    model = torch.load('../../../trained-models/4th-phase/default_model_tuned_on_15_scenarios/transformer_tuned_on_15_scenarios-default.pth')
    ...
    plotting.denorm_and_plot_predicted_actual(output_columns_jobs, output_jobs_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="17-hard_extrapolation_x10")

    # Create KDE plot
    plotting.plot_kde(output_columns_jobs, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="17-hard_extrapolation_x10")
