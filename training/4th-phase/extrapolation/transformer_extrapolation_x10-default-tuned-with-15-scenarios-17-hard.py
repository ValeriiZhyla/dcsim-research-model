...
# Load dataframes
test_df = pd.read_csv(
    '../../../dataset_preparation/4th-phase/extrapolation/17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation/extrapolation_dataset.csv', sep=";")
nodes_aux_df = pd.read_csv(
    '../../../dataset_preparation/4th-phase/extrapolation/17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation/nodes_aux.csv', sep=";")
links_aux_df = pd.read_csv(
    '../../../dataset_preparation/4th-phase/extrapolation/17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation/links_aux.csv', sep=";")
