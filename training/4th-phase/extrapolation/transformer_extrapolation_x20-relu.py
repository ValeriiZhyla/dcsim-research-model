...
import windowing
import plotting
from initial_training.transformer_initial_training_ReLU import TransformerModelWithTwoAuxEncoders, CombinedDataset, model_name, WINDOW_SIZE, WINDOW_OVERLAP_SIZE, BATCH_SIZE, plot_color
...
def apply_model_to_data():
    ...
    model = torch.load('../../../trained-models/4th-phase/initial_model_relu/transformer-relu.pth')
