...
nodes_aux_df = pd.read_csv(
    '../../../dataset_preparation/4th-phase/extrapolation/16-kit_desy-cache-moved-to-desy-more-resources-in-desy-less-resources-in-kit-faster-links-extrapolation/nodes_aux.csv', sep=";")
links_aux_df = pd.read_csv(
    '../../../dataset_preparation/4th-phase/extrapolation/16-kit_desy-cache-moved-to-desy-more-resources-in-desy-less-resources-in-kit-faster-links-extrapolation/links_aux.csv', sep=";")
