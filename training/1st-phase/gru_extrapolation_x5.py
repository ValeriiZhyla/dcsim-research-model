...
import apply_model
from gru_training import BiGRUModel, model_name, WINDOW_SIZE, WINDOW_OVERLAP_SIZE, BATCH_SIZE, plot_color, input_columns, output_columns

purpose="extrapolation"

TEST_PATH = '../../dataset_preparation/1st-phase/extrapolation_dataset.csv'
