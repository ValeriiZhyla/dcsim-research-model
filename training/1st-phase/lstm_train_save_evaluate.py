...
hyperparameter_combinations = [
    ...
    Hyperparameters(epochs=200, window_size=50, window_overlap=49, batch_size=128, hidden_layers=10),  # Rolling window, less layers
    Hyperparameters(epochs=200, window_size=50, window_overlap=49, batch_size=128, hidden_layers=50),  # Rolling window, medium layers
    Hyperparameters(epochs=200, window_size=50, window_overlap=49, batch_size=128, hidden_layers=125)  # Rolling window, more layers
