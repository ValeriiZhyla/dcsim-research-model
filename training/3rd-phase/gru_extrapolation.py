...
train_df = pd.read_csv('../../dataset-preparation/3rd-phase/extrapolation_dataset_x5.csv')
...
def apply_model_to_data():
    ...
    model = torch.load('../../trained-models/3rd-phase/gru.pth')
    ...
    commons.denorm_and_plot_predicted_actual(output_columns, output_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="extrapolation")
    # Create KDE plot
    commons.plot_kde(output_columns, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="extrapolation")
