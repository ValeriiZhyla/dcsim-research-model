...
train_df = pd.read_csv('../../dataset-preparation/3rd-phase/test_dataset.csv')
...
def apply_model_to_data():
    ...
    commons.denorm_and_plot_predicted_actual(output_columns, output_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="interpolation", add_help_line=True)
    # Create KDE plot
    # commons.denorm_and_plot_kde(output_columns, output_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="interpolation")
