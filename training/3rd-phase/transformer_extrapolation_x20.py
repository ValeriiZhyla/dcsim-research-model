...
train_df = pd.read_csv('../../dataset-preparation/3rd-phase/extrapolation_dataset_x20.csv')
...
def apply_model_to_data():
    ...
    commons.denorm_and_plot_predicted_actual(output_columns, output_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="extrapolation_x20", add_help_line=True)
    # Create KDE plot
    commons.plot_kde(output_columns, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="extrapolation_x20")
