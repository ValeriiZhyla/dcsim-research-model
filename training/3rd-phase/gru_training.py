...
TRAIN_PATH = '../../dataset-preparation/3rd-phase/train_dataset.csv'
TEST_PATH = '../../dataset-preparation/3rd-phase/test_dataset.csv'
# TRAIN_PATH = '../../dataset-preparation/3rd-phase/train_dataset_small.csv'
# TEST_PATH = '../../dataset-preparation/3rd-phase/test_dataset_small.csv'
