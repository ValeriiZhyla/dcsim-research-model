...
train_df = pd.read_csv('../../dataset-preparation/2nd-phase/test_dataset.csv')
...
def apply_model_to_data():
    ...
    commons.denorm_and_plot_predicted_actual(output_columns, output_scaler, predictions_array, actual_values_array, model_name, color_name=plot_color, purpose="interpolation")
