...
hyperparameter_combinations = [
    ...
    Hyperparameters(epochs=300, window_size=100, window_overlap=0, batch_size=32, hidden_size=128, layers=1),
    Hyperparameters(epochs=300, window_size=100, window_overlap=0, batch_size=64, hidden_size=128, layers=1),
    Hyperparameters(epochs=300, window_size=100, window_overlap=0, batch_size=128, hidden_size=128, layers=1),
