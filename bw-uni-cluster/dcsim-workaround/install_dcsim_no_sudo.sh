...
cmake -DCMAKE_CXX_COMPILER=g++ -DCMAKE_INSTALL_PREFIX="/home/kit/kastel/jn1292/local" ../
make -j16
make install
popd
...
pushd simgrid/build
cmake -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_INSTALL_PREFIX="/home/kit/kastel/jn1292/local" ../
make -j16
make install
popd
