...
nohup python -u schedule-simulations.py --script_to_start=starters/start_second_phase_10.sh --directory_to_check=second_phase_10 --total_simulations_number=10 --minutes_between_checks=1 > scheduler_second_phase_10.log 2> scheduler_second_phase_10_error.log &
...
nohup python -u schedule-simulations.py --script_to_start=starters/start_second_phase_250.sh --directory_to_check=second_phase_250 --total_simulations_number=10 --minutes_between_checks=2 > scheduler_second_phase_250.log 2> scheduler_second_phase_250_error.log &
