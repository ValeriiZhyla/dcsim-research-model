ID="17-kit_desy-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation"
PATH_PREFIX="dcsim-configurations/4th-phase/extrapolation/${ID}"
PLATFORM="${PATH_PREFIX}/platform/WLCG_disklessTier2_reduced100-cache-moved-to-desy-two-more-desy-hosts-and-more-resources-less-hosts-in-kit-and-less-resources-extrapolation.xml"
