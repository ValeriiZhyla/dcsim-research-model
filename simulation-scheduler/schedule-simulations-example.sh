...
nohup python -u schedule-simulations.py --script_to_start=starters/start_first_phase.sh --directory_to_check=first_phase --total_simulations_number=1000 --minutes_between_checks=1 &
